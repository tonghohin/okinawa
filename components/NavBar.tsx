    ...
    return (
        <nav className="bg-yellow-500 rounded flex items-center gap-6 p-4">
            ...
            <div className="flex-1 flex items-center gap-4">
                <Link href="/admin" className={`${pathname === "/admin" && "border-b-2 border-zinc-800"}`}>
                    Home
                </Link>
                <Link href="/admin/menu" className={`${pathname === "/admin/menu" && "border-b-2 border-zinc-800"}`}>
                    整Menu
                </Link>
                <Link href="/admin/orders" className={`${pathname === "/admin/orders" && "border-b-2 border-zinc-800"}`}>
                    睇Order
                </Link>
            </div>
